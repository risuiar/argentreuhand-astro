...
export default function WhyChooseUs({ lang, translations }: WhyChooseUsProps) {
  ...
  return (
    <section id="sobre-nosotros" className="py-20 bg-gradient-to-br from-slate-50 to-white">
        ...
        <div className="mt-20 bg-white rounded-3xl p-8 shadow-xl border border-slate-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-slate-600">{t.whyChooseUs.stats.clients}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-emerald-600 mb-2">98%</div>
              <div className="text-slate-600">{t.whyChooseUs.stats.satisfaction}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-purple-600 mb-2">€2M+</div>
              <div className="text-slate-600">{t.whyChooseUs.stats.savings}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-yellow-600 mb-2">24h</div>
              <div className="text-slate-600">{t.whyChooseUs.stats.response}</div>
            </div>
          </div>
        </div>
      </div>
